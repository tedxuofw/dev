...
<<template>
  <ConferencePage :selectedIndex="5">
    <div class="outer">
      <iframe class="video" src="https://www.youtube.com/embed/qPvVcC_pPiE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      <div class="position">
      ...
      <!--   
      <div class="column1">
        <img src="static/speakers_2021_background_lower_res.png" class="img" alt="background image" >
      </div>
      -->
      <!--
      <div class="column2">
        <img src="static/schedule.png" class="img2" alt="schedule of events">
      </div>
      -->
